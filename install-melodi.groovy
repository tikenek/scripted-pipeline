...
node {
    ...
    stage("Install Melodi"){
        ansiblePlaybook become: true, colorized: true, credentialsId: 'Jenkins-master-ssh', disableHostKeyChecking: true, inventory: "${params.node},", playbook: 'ansible-melodi/main.yml'
    }    
}